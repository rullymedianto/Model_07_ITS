...
%Conflict Definition and Detection
    for c1 = 1:airplane
            for c2 = 1:airplane
                ...
                if Distance_XY{1,i}(c1,c2) < buffer_zone && Distance_XY{1,i}(c1,c2) ~= 0 && Distance_Altitude{1,i}(c1,c2) <= meter(2000)
...
% % Conflict Definition              
                if Distance_XY{1,i}(c1,c2) < conflict_separation  && Distance_XY{1,i}(c1,c2) ~= 0 && Distance_Altitude{1,i}(c1,c2) <= meter(1000)
...
Sim1{1,i+1}(9,j) = clearance(ROW_Detail{1,i},Conflict_1{1,i},airplane,j,Distance_XY{1,i},conflict_separation);
        % 0 : No clearance
        % 1 : Clearance
%Resolution (10)
