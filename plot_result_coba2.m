...
w2 = 2  ; % Weighting factor for number of conflict
w3 = 0.7  ; % Weighting factor for number of climbing A/C 
w4 = 1 ; % Weighting factor  for number of descending A/C
w5 = 0.2  ; % Weighting factor for number of cruising A/C 
w6 = 0.7  ; % Weighting factor for speed ratio
...
subplot(5,2,1)
        ...
        acinsectorArray1(1,1) = 0;
        acinsectorArray1(1,i+1) = acinsector1(Sim1{1,i},airplane);
        plotacinsector = plot([1:i],acinsectorArray1(1,[1:i]),'r');
        xlim([0 t])
        ylim([0 yl])
        xlabel('time')
        ylabel('Aircraft')
...
subplot(5,2,2)   
        numofconflictArray1(1,1) = 0;
        numofconflictArray1(1,i+1) = numofconflict1(Sim1{1,i},airplane);  
        plotnumofconflict = plot([1:i],numofconflictArray1(1,[1:i]),'r');
        xlim([0 t])
        ylim([0 yl])
        xlabel('time')
        ylabel('Conflict')
...
subplot(5,2,3)
        ...
        ac_climbArray1(1,1) = 0;
        ac_climbArray1(1,i+1) = ac_climb1(Sim1{1,i},Sim1{1,i+d},airplane);
        plot([1:i],ac_climbArray1(1,[1:i]),'b');
...
subplot(5,2,4)
        ...
        ac_descentArray1(1,1) = 0;
        ac_descentArray1(1,i+1) = ac_descent1(Sim1{1,i},Sim1{1,i+d},airplane);
        plot([1:i],ac_descentArray1(1,[1:i]),'r');
 ...
 subplot(5,2,5)
 ac_cruiseArray1(1,1) = 0;
 ac_cruiseArray1(1,i+1) = ac_cruise1(Sim1{1,i},Sim1{1,i+d},airplane);
 plot([1:i],ac_cruiseArray1(1,[1:i]),'r');
    ...
    subplot(5,2,6)
    speed_ratioArray1(1,1) = 0;
    speed_ratioArray1(1,i+1) = speed_ratio(Sim1{1,i+1},airplane);
        plot([1:i],speed_ratioArray1(1,[1:i]),'r');
 ...
 subplot(5,2,7)
 same_runwayArray1(1,1) = 0;
 same_runwayArray1(1,i+1) = same_runway1(Sim1{1,i},airplane);
        plot([1:i],same_runwayArray1(1,[1:i]),'r');
...
subplot(5,2,8)        
overtaking_conflictArray1(1,1) = 0;
overtaking_conflictArray1(1,i+1) = overtaking_conflict1(Sim1{1,i+1},airplane);
plot([1:i],overtaking_conflictArray1(1,[1:i]),'r');
...
subplot(5,2,9)
crossing_conflictArray1(1,1) = 0;
crossing_conflictArray1(1,i+1) = crossing_conflict1(Sim1{1,i+1},airplane);
plot([1:i],crossing_conflictArray1(1,[1:i]),'r');
...
plotnumofcomplexity = plot([1:i],numofcomplexityArray,'r');       
