...
%          
          plotwaypoint2 = scatter(NavData(1:34,1),NavData(1:34,2),5,'filled','b'); %Arr WP
          txt2a = text(NavData(1:34,1),NavData(1:34,2),label(1:34,1),'FontSize',5,'HorizontalAlignment','right');
...
%              aa = round(mps2kt(Sim1{1,i}(19,:)')); 
        ...
        %if aa < 100
            txt1 = text(Sim1{1,i}(2,:)+dx1, Sim1{1,i}(3,:)+dy1, cc,'color','red','FontSize',7);
            txt2 = text(Sim1{1,i}(2,:)+dx2, Sim1{1,i}(3,:)+dy2, cc1,'color','red','FontSize',7);
...
%         delete(plotcapacity);
R= nm(75);
gambar_lingkaran=circleplot(-29127.2,-71619.2,R)
              end
          end
